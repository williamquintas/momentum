...
- Example:
  ...
  export const fetchGoals = createAsyncThunk('goals/fetchGoals', async (filters: GoalFilters) => {
...
- Example:
  ...
  const completedGoals = useGoalsStore((state) => state.goals.filter((g) => g.status === 'completed'));
