...
export const MilestoneGoalFields: React.FC = () => {
  ...
  return (
    <>
          ...
          <>
                ...
                <Row gutter={16} style={{ width: '100%' }}>
                  <Col xs={24} md={6}>
                    <Form.Item
                      ...
                      label={t('milestoneFields.title', { number: index + 1 })}
                      rules={[{ required: true, message: t('milestoneFields.titleRequired') }]}
                    >
                      <Input placeholder={t('milestoneFields.titlePlaceholder')} />
                    </Form.Item>
                  </Col>
                  <Col xs={24} md={10}>
                    <Form.Item
                      ...
                      label={t('milestoneFields.description')}
                    >
                      <Input placeholder={t('milestoneFields.descriptionPlaceholder')} />
                    </Form.Item>
                  </Col>
                  <Col xs={24} md={4}>
                    <Form.Item
                      ...
                      label={t('milestoneFields.dueDate')}
                    >
            ...
            <Form.Item>
              <Button
                ...
                icon={<PlusOutlined />}
              >
                {t('milestoneFields.addMilestone')}
              </Button>
            </Form.Item>
          </>
        )}
      ...
      <Form.Item name="allowMilestoneReordering" valuePropName="checked" label={t('milestoneFields.allowReordering')}>
      ...
      <Form.Item
        ...
        label={t('milestoneFields.requireSequential')}
      >
        <Switch defaultChecked={false} />
      </Form.Item>
    </>
