...
- Reference materials for stakeholders
...
1. Save the image file in this directory with a descriptive name (e.g., `feature-name-mockup.png`)
2. Create a corresponding markdown file (e.g., `feature-name-mockup.md`) that includes:
   - Overview of the mockup
   - Detailed description of UI elements
...
- Include "mockup" in the filename
- Be descriptive (e.g., `goal-creation-form-mockup.png`)
